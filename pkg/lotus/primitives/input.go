// Package primitives provides core form input components for Lotus applications
// Primitives map to browser DOM elements: Input (<input>), TextArea (<textarea>), ScrollView (overflow: scroll)
package primitives
