...
func TestInput_MultiLineNavigation(t *testing.T) {
	input := NewInput().WithWidth(20)
	input.Value = "Line 1\nLine 2\nLine 3"
...
func TestInput_MultiLineNavigationWithColumn(t *testing.T) {
	input := NewInput().WithWidth(20)
...
func TestInput_GetCurrentLineAndCol(t *testing.T) {
	tests := []struct {
		name         string
		value        string
		cursorPos    int
...
func TestInput_EnterStillSubmits(t *testing.T) {
	input := NewInput().WithWidth(20)
	input.Value = "Hello"
	input.CursorPos = 5
...
func TestInput_MultiLineRendering(t *testing.T) {
	input := NewInput().WithWidth(20)
...
func TestInput_UpDownArrowKeys(t *testing.T) {
	input := NewInput().WithWidth(20)
	input.Value = "Line 1\nLine 2\nLine 3"
	input.CursorPos = 0
