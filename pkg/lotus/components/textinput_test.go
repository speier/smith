...
func TestTextInput_CursorStyle(t *testing.T) {
	input := NewTextInput()
...
func TestTextInput_CursorChar(t *testing.T) {
	input := NewTextInput()
...
func TestTextInput_CursorBlinkUpdate(t *testing.T) {
	input := NewTextInput()
...
func TestTextInput_CursorBlinkDisabled(t *testing.T) {
	input := NewTextInput()
	input.SetCursorBlink(false)
...
func TestTextInput_GetDisplayWithCursor(t *testing.T) {
	input := NewTextInput().WithWidth(20)
...
func TestTextInput_GetDisplayWithCursor_DifferentStyles(t *testing.T) {
	input := NewTextInput().WithWidth(20)
	input.Value = "Test"
	input.CursorPos = 2
	input.Scroll = 0
...
func TestTextInput_TypingFlow(t *testing.T) {
	input := NewTextInput().WithWidth(20)
	input.Placeholder = "Type here..."
	input.SetCursorBlink(false)
...
func TestTextInput_ScrollingWithCursor(t *testing.T) {
	input := NewTextInput().WithWidth(5) // Only 5 chars visible
	input.SetCursorBlink(false)
...
func TestTextInput_WithPlaceholder(t *testing.T) {
	input := NewTextInput().WithPlaceholder("Enter name...")
